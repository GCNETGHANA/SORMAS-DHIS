...
<%@page import="com.mirabilia.org.hzi.Util.EntryControllers.AuthUser"%>
<%@page import="com.mirabilia.org.hzi.Util.Users"%>
...
<html lang="en">
    <jsp:include page="template/head.jsp"></jsp:include>
        ...
        <body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed control-sidebar-slide-open accent-purple">
            ...
            <%
                List<Users> userList = AuthUser.getUsers();
                            ...
                            <div class="card card-default">
                                ...
                                <div class="row d-flex flex-column justify-content-center align-items-center">
                                    <div class="table-wrapper">
                                        <table id="users" class=" fl-table table-borderless">
                                            <thead>
                                                <tr>
                                                    <th>Username</th>
                                                    <th>Access</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-row align-items-center justify-content-around">
                                                            <i class="fa fa-edit" onclick="editUser(${u.id})"></i>
                                                            <i class="fa fa-trash" onclick="deleteUser(${u.id})"></i>
                                                        </div>
                                                    </td>
                                                </tr>
